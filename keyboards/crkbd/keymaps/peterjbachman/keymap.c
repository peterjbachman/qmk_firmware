...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------|                |------+------+-------+------+-------+--------|
    OSM(MOD_HYPR),  KC_A,  KC_S,  KC_D, LSFT_T(KC_F),  KC_G,    KC_H, RSFT_T(KC_J),  KC_K,  KC_L, KC_SCLN,KC_QUOT,
  //|------+------+------+------+------+------|                |------+------+-------+------+-------+--------|
    KC_LSPO,  KC_Z,  KC_X,  KC_C,  KC_V,  KC_B,                   KC_N,  KC_M,KC_COMM,KC_DOT,KC_SLSH,KC_RSPC,
  //|------+------+------+------+------+------+------|  |------+------+------+-------+------+-------+--------|
                               KC_LGESC,LOWER, KC_SPC,   RCTL_T(KC_ENT),RAISE,RALT_T(KC_BSPC)
                              //`--------------------'  `--------------------'
  ),
    ...
    case KC_RABS:
        if (record->event.pressed) {
          ...
          if (timer_elapsed(my_colon_timer) < TAPPING_TERM) {
            register_code(KC_BSPC); // Change the character(s) to be sent on tap here
          }
        }
        return false;
    case RGBRST:
